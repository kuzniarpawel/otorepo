...
| **D2** | **AUVP: alternatywa czy koniunkcja** (§3.4) | (a) czytać notę 12 (szerzej, więcej rozpoznań); (b) czytać §4.4.1 (wężej); (c) zapisać obie i nie rozstrzygać, oznaczając sprzeczność źródła |
