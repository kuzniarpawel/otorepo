...
export const ATLAS = [
  ...
  },
  {
    ...
    granicePl: [
      "PIERWOTNY PEŁNY TEKST (2017) NIESIE WYŁĄCZNIE PRZYPIS O ISTNIENIU ERRATY, BEZ JEJ TREŚCI — do 2026-08-22 ta granica ostrzegała więc, że nie wiadomo, czy któryś z progów skorygowano. Errata została odnaleziona i zastosowana w tym wpisie 2026-08-22: kryterium C-3 i progi fotela obrotowego noszą liczby po korekcie, a pełną treść poprawki — wraz z dwoma rozjazdami, których errata NIE zamyka — niesie następna pozycja tej listy.",
      "PRÓG FOTELA OBROTOWEGO MIAŁ W PRACY Z 2017 TRZY BRZMIENIA — ERRATA Z 2023 ZAMKNĘŁA TYLKO JEDNO. Errata (J Vestib Res 2023;33(1):87) poprawia linię kryterium C-3 na: gain ≤ 0,1 przy 0,1 Hz i 50°/s ORAZ phase lead ≥ 15 stopni (stała czasowa ≤ 6 s); pierwotnie stało tam > 68 stopni i < 5 s. NIE ZAMKNIĘTE ZOSTAJĄ DWA ROZJAZDY: (1) abstrakt łączy te wielkości spójnikiem „i/lub\" (wystarczy jedno), a linia kryteriów — spójnikiem ORAZ, i errata abstraktu nie rusza; (2) nota o badaniach obrotowych podaje wciąż inną wersję: gain < 0,15 przy 0,05–0,1 Hz i 60°/s. Errata noty nie dotyczy.",
    ...
    graniceEn: [
      "THE ORIGINAL FULL TEXT (2017) CARRIES ONLY A FOOTNOTE RECORDING THAT AN ERRATUM EXISTS, WITHOUT ITS CONTENT — until 2026-08-22 this limitation therefore warned that it was unknown whether any threshold had been corrected. The erratum was found and applied to this entry on 2026-08-22: criterion C-3 and the rotatory-chair thresholds now carry the corrected figures, and the full content of the correction — together with the two divergences the erratum does NOT close — is carried by the next item in this list.",
      "THE ROTATORY-CHAIR THRESHOLD HAD THREE WORDINGS IN THE 2017 PAPER — THE 2023 ERRATUM CLOSED ONLY ONE. The erratum (J Vestib Res 2023;33(1):87) corrects the criterion C-3 line to: gain ≤ 0.1 at 0.1 Hz and 50°/s AND a phase lead ≥ 15 degrees (time constant ≤ 6 s); the original read > 68 degrees and < 5 s. TWO DIVERGENCES REMAIN OPEN: (1) the abstract joins these quantities with „and/or\" (either suffices) while the criteria line uses AND, and the erratum does not touch the abstract; (2) the note on rotational testing still gives yet another version: gain < 0.15 at 0.05–0.1 Hz and 60°/s. The erratum does not concern the note.",
