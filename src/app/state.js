...
const state={
  ...
  exam:null,        // D7/V21: egzamin „zbadaj pacjenta" — null=OFF (ścieżka bit-identyczna); ON: {seed, row, p, lesions:[{canal,side,variant,mech}], revealed} — pacjent UKRYTY, karty liczą z niego (nie z variant/mechanism)
