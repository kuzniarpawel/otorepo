...
import { openHints, setHintsFix, setHintsGaze, HINTS_PRESETS, loadHintsPreset, loadHintsNeuritis, openHintsCustom, exitHintsCustom, setHintsNerveEar, setHintsNerveBranch, setHintsNerveSev, loadHintsFromHash, openTest, setDixObs, setVariant, toggleDiagCentral, openTriage, setTriage, toggleTriageFlaga, resetTriage, goObs, setObsPole, oznaczObsPole, setObsGrupa, wyczyscObs, przyjmijObs, genPlan, setGuideSide, setDiagSide, startManeuver, syncLangBar, setMode, setLangUI } from './app/actions.js';
