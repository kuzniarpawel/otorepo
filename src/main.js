...
import { goKontrola, wrocDoManewru, ustawWynikKontroli, ustawPowodKontroli, kontrolaAkcja, kontrolaAlternatywa, powtorzManewrKontroli, pytajOZakonczeniu, zakonczSesje, openHints, setHintsFix, setHintsGaze, HINTS_PRESETS, loadHintsPreset, loadHintsNeuritis, openHintsCustom, exitHintsCustom, setHintsNerveEar, setHintsNerveBranch, setHintsNerveSev, loadHintsFromHash, openTest, setDixObs, setVariant, toggleDiagCentral, openTriage, setTriage, toggleTriageFlaga, resetTriage, pickCanal, pickSide, openMan, goStep, pickSize, zakonczSerie, ustawTrybCzasu, zmienManewr, potwierdzPrzerwe, goObs, setObsPole, oznaczObsPole, setObsGrupa, wyczyscObs, przyjmijObs, goInterpret, przyjmijMechanizm, nadpiszMechanizm, wrocDoWyprowadzonego, idzDoProby, genPlan, setGuideSide, setDiagSide, startManeuver, syncLangBar, setMode, setLangUI } from './app/actions.js';
