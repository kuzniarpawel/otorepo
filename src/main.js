...
window.__OTOREPO_TEST__ = { Vestibular, NeuroVOR, Scene3D, composeHead, stepHeadQ, stepGravity, bodyJoints, poseSpec, gravArrowFor, genPlan, MANEUVERS, CANALS, DIAG, CANAL_OF, HINTS_PRESETS, TORSO_Q, state, render, startManeuver, setGuideSide, openTest, setDiagSide, setDixObs, setVariant, setMechanism, setBltScenario, maneuverTimeline, actTimeline, sessionSim, sessionPreview, readhesion, SESSION_REST, SIT_SEG, ldtPhases, nullScan, nullYawOf, engineXi, provokeQ, HC_TILT_DEG, HC_FLEX_DEG, spvTrace, XI_VIS: xiVis(), MECHS_BY_PHENO, mechOf, variantOfMech, persistentOf, SHORT_PHI0, rollShortPhases, ENS_GRID, ensembleSim, maneuverSim, toggleEnsembleMode, toggleSessionMode, resetSession, sessionProvoke, seedSessionFromScenario, sessionManeuver, sessionRest, openHints, loadHintsPreset, loadHintsNeuritis, openHintsCustom, exitHintsCustom, setHintsFix, setHintsGaze, setHintsNerveEar, setHintsNerveBranch, setHintsNerveSev, PRIORS, mulberry32, randomPatient, TEST_OF_CANAL, examPhaseNys, examAnswerKey, recommend, baranyClassify, nysFromGeom, examStart, newExamPatient, examReveal, examEnd, toggleExamMode, TEVS_REST, tevsDemoSim, JAM_DEMO, jamDemo, toggleDiagCentral };
