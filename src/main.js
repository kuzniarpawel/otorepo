...
import { MANEUVERS, CANALS, stepGravity, stepHeadQ, composeHead, TORSO_Q, bodyJoints, poseSpec, gravArrowFor, DIAG, CANAL_OF, maneuverTimeline, actTimeline, sessionSim, readhesion, SESSION_REST, SIT_SEG } from './pose/maneuvers.js';
...
window.__OTOREPO_TEST__ = { Vestibular, NeuroVOR, Scene3D, composeHead, stepHeadQ, stepGravity, bodyJoints, poseSpec, gravArrowFor, genPlan, MANEUVERS, CANALS, DIAG, CANAL_OF, HINTS_PRESETS, TORSO_Q, state, render, startManeuver, setGuideSide, openTest, setDiagSide, setDixObs, setVariant, setBltScenario, maneuverTimeline, actTimeline, sessionSim, readhesion, SESSION_REST, SIT_SEG, toggleSessionMode, resetSession, sessionProvoke, sessionManeuver, sessionRest, openHints, loadHintsPreset, loadHintsNeuritis, openHintsCustom, exitHintsCustom, setHintsFix, setHintsGaze, setHintsNerveEar, setHintsNerveBranch, setHintsNerveSev };
