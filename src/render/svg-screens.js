  ...
  return `<details class="advbox" ${open||state.hintsVmCrit?"open":""} ontoggle="setHintsVmCrit(this.open)"><summary>${t("Kryteria migreny przedsionkowej — Bárány Society / IHS","Diagnostic criteria for vestibular migraine — Bárány Society / IHS")}</summary>
    ...
    <div class="redflag" style="margin-top:11px"><b>${t("⚠ Kryterium D — zanim rozpoznasz, wyklucz","⚠ Criterion D — rule out before you diagnose")}</b>
      <ul style="margin:7px 0 0;padding-left:18px;line-height:1.5">
        ...
        <li>${t("<b>Choroba Ménière'a</b> — gdy spełnione są jej kryteria [H20] Lopez-Escamez 2015, zwłaszcza przy udokumentowanym audiometrycznie jednostronnym niedosłuchu, rozpoznaje się Ménière'a nawet wtedy, gdy w napadach występują objawy migrenowe. <b>Oba</b> rozpoznania stawia się tylko u chorego mającego <b>dwa różne typy napadów</b>: jeden spełniający kryteria migreny przedsionkowej, drugi kryteria Ménière'a. Reguła pierwszeństwa i reguła dwóch typów napadów — [H46] Lempert 2022.","<b>Menière's disease</b> — when its criteria [H20] Lopez-Escamez 2015 are met, especially with audiometrically documented unilateral hearing loss, Menière's is diagnosed even if migraine symptoms occur during the attacks. <b>Both</b> diagnoses are made only in a patient who has <b>two different types of attacks</b>: one fulfilling the vestibular-migraine criteria, the other Menière's. The precedence rule and the two-attack-types rule — [H46] Lempert 2022.")}</li>
        <!-- D6/NAPADOWICA (2026-08-22): stalo tu „napady trwajace od jednej do kilku sekund" — okno
             ZANIZONE wobec zrodla, i to w miejscu, gdzie napadowica sluzy jako pozycja WYKLUCZAJACA
             migrene. Kryterium B [H49] Strupp 2016: postac pewna < 1 minuty, prawdopodobna < 5 minut.
             Chory z napadami 40-sekundowymi byl naszym brzmieniem odrzucany, choc kryterium go obejmuje.
             GRANICA ZRODLA, ktora tu NIE WCHODZI: nota 4 [H49] rozszerza czas jeszcze dalej — u czesci
             chorych napady „may be longer up to many minutes" — czyli nota PRZECZY kryterium B tej samej
             pracy. Karta oddaje KRYTERIUM, bo to ono jest kryterium; rozbieznosc odnotowana tutaj,
             zeby nikt nie „poprawil" karty na notę. -->
        <li>${t("<b>Napadowica przedsionkowa</b> — napady zawrotu <b>poniżej 1 minuty</b> (postać pewna) albo <b>poniżej 5 minut</b> (prawdopodobna), stereotypowe, nawracające wielokrotnie w ciągu doby; postać pewna wymaga też odpowiedzi na karbamazepinę, prawdopodobna dopuszcza napady prowokowane ruchem głowy — [H49] Strupp 2016. Ważne tu, bo reguła liczenia napadów sekundowych (niżej) sama otwiera na ten fenotyp furtkę.","<b>Vestibular paroxysmia</b> — attacks of vertigo lasting <b>less than 1 minute</b> (definite) or <b>less than 5 minutes</b> (probable), stereotyped, recurring many times a day; the definite form also requires a response to carbamazepine, the probable form admits attacks provoked by head movements — [H49] Strupp 2016. Relevant here because the counting rule for attacks of seconds (below) opens the door to this phenotype.")}</li>
